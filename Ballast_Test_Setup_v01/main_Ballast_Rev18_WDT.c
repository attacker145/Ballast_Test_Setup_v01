...
void main(void)
{
    ...
    * It should be remembered that ACLK is being sourced by VLO as well. This is because of the fact that ACLK is sourced from LFXT1 by default.
    */
...
#define debug
    ...
    */
    ...
    GPIO_setOutputLowOnPin(GPIO_PORT_P1, GPIO_PIN5);    // Turn OFF relay1
    GPIO_setOutputLowOnPin(GPIO_PORT_P2, GPIO_PIN0);    // Turn OFF relay2
    ...
    //GPIO_setOutputHighOnPin(GPIO_PORT_P3,GPIO_PIN5); // Set RESET pin High
